(function(module) {
    ...
    var getMessage = function() {
        ...
        var req = http.request({
            ...
            res.on('data', function (chunk) {
                ...
                var fromId = parseInt(msg.fromUid);
                if (!filterFlag || (fromId >= startId && fromId <= endId) || addon.indexOf(fromId) > -1) {
                    ...
                    Debug.log('Receive', 'Ignore Message. UID : ' + fromId);
                }
            });
    ...
    var Listener = {
        ...
        openFilter : function(sId, eId, add) {
            filterFlag = true;
            startId = parseInt(sId);
            endId = parseInt(eId);
            addon = [].concat(add);
        }
    };
